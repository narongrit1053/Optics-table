...
export const DEFAULT_DIMENSIONS_MM = {
    ...
    hwp: { length: 15.5, width: 55.4, height: 55.4 },
    qwp: { length: 15.5, width: 55.4, height: 55.4 },
    polarizer: { length: 15.5, width: 55.4, height: 55.4 },
    pbs: { length: 12.7, width: 12.7, height: 12.7 },
    poldetector: { length: 12, width: 12, height: 12 },
    vaporcell: { length: 75, width: 25, height: 25 },
